...
**2. Update package.json - add MCP scripts:**
...
Note: The mcp:build script references a tsconfig.mcp.json that would compile only the MCP server. For simplicity, we can use tsx for development and skip building for now.
