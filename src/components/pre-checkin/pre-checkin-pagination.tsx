...
/**
 * PreCheckinPagination Component
 *
 * Pagination controls for pre-checkin list.
 ...
 */
export function PreCheckinPagination({
  currentPage,
  totalPages,
  totalItems,
  itemsPerPage,
}: PreCheckinPaginationProps) {
    ...
    <div className="bg-white rounded-lg border p-4">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="text-sm text-gray-600 order-1 sm:order-1">
          Pagina {currentPage} de {totalPages || 1} • Mostrando {startItem}-{endItem} de {totalItems} pre-checkins
        </div>
